...
public:
    ...
    QAction *Act_view_tool, *Act_view_image,*Act_view_geom, *Act_view_gray, *Act_view_enhance,
...
private:
    ...
    void Menu_CycleGan();   // 风格迁移
	void Menu_Help();		// 帮助菜单

	// 二级菜单
    QMenu *menu_resize, *menu_rotate, *menu_flip, *menu_nolinear, *menu_detect, *menu_smooth, *menu_sharpen,*menu_cycleGan;
