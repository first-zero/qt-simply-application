...
public:
    ...
    QDockWidget *dock_Geom, *dock_Gray,	*dock_Enhance, *dock_Color;

//    bool matIsEqual(const cv::Mat mat1, const cv::Mat mat2);  //图像比较
...
public slots:
    ...
    void candyImage();                          //candy风格迁移检测
    void feathersImage();                       //feathers风格迁移检测
    void la_museImage();                        //la_muse风格迁移检测
    void mosaicImage();                         //mosaic风格迁移检测
    void starry_nightImage();                   //starry_night风格迁移检测
    void the_screamImage();                     //the_scream风格迁移检测
    void udnieImage();                          //udnie风格迁移检测
